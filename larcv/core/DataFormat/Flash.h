    ...
    */
    ...
    public:
        ...
        Flash(double time=0, double timeWidth=0, double absTime=0, unsigned int frame=0,
            std::vector<double> PEPerOpDet=std::vector<double>(0), int tpc=0,
        ...
        inline int tpc () const { return _tpc; }
        ...
        inline void tpc (int tpc) { _tpc = tpc; }
    ...
    private:
        ...
        int _tpc; ///< ID of the hit TPC (0-7)
